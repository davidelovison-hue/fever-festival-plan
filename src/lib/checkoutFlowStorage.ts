...
const BASKET_PREFIX = 'fever-festival-plan:basket:'
const CONNECT_PREFIX = 'fever-festival-plan:connect:'
const GUEST_CONTACT_PREFIX = 'fever-festival-plan:guest-contact:'
